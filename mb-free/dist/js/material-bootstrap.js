...
(function($){
  ...
  MB.textareaAutoResize = function($textarea) {
  ...
  $(document).ready(function() {
    ...
    $(document).on('blur', input_selector, function () {
      ...
      MB.validate_field($inputElement);
    });
    ...
    $(text_area_selector).each(function () {
      ...
      $textarea.data('original-height', $textarea.outerHeight());
      $textarea.data('previous-length', $textarea.val().length);
      MB.textareaAutoResize($textarea);
    });

    $(document).on('keyup keydown', text_area_selector, function () {
      MB.textareaAutoResize($(this));
    });
